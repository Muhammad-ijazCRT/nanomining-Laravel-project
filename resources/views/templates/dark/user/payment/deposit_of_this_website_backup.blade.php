            ...
            <form action="{{ route('user.deposit.insert') }}" method="post">
                ...
                <div class="row gy-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control form--control" name="amount" type="number" value="{{ getAmount($order->amount) }}" step="any" autocomplete="off" required @readonly($order)>
                            <span class="input-group-text append-icon--btn">{{ $general->cur_text }}</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">@lang('Select Gateway')</label>
                        <select class="custom--select form--control" name="gateway" required>
                    ...
                    <div class="form-group"><button class="btn--base w-100" type="submit">@lang('Submit')</button></div>
                </div>
            </form>
        </div>
    </div>
