                    ...
                    <div class="wallet-card-body">
                        ...
                        <div class="top flex-wrap">
                            <img alt="Image" class="logo"
                                src="{{ getImage(getFilePath('miner') . '/' . $data->miner->coin_image, getFileSize('miner')) }}">
                            <div>
                                <h5 class="title">{{ strtoupper($data->miner->coin_code) }} @lang('Wallet')</h5>
                                <small>{{ showAmount($data->balance, 8, exceptZeros: true) }}</strong>
                                    {{ strtoupper($data->miner->coin_code) }}</small>
                            </div>

                            <div class="ms-sm-auto">
                                <button class="btn btn--sm btn--base withdrawBtn withdraw-btn"
                                    data-coin_code="{{ __(strtoupper($data->miner->coin_code)) }}"
                                    data-id="{{ $data->id }}" data-resource="{{ $data }}"
                                    data-wallet_address="{{ $data->wallet }}" type="button">
                                    @lang('Withdraw Now')
                                </button>
                            </div>
                        </div>
                        ...
                        <p class="address">
                            ...
                            <span class="value">
                                ...
                                @else
                                    ...
                                    <a class="text--base"
                                        href="{{ route('user.wallets') }}?coin_code={{ strtoupper($data->miner->coin_code) }}">
                                        @lang('Update now')
                                    </a>
                                @endif
                            </span>
                        ...
                        <p class="address mt-3">
                            ...
                            <span class="value">
                                {{ showAmount($data->miner->min_withdraw_limit, 8, exceptZeros: true) . ' ' . strtoupper($data->miner->coin_code) }}
                            </span>
                        </p>
                        ...
                        <p class="address mt-3">
                            ...
                            <span class="value">
                                {{ showAmount($data->miner->max_withdraw_limit, 8, exceptZeros: true) . ' ' . strtoupper($data->miner->coin_code) }}
                            </span>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <input class="form-control form--control" id="amount" name="amount"
