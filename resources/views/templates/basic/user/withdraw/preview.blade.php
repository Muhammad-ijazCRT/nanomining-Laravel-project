        ...
        <div class="col-md-6">
            <ul class="list-group">
                <li class="list-group-item rounded-0 d-flex justify-content-between">
                    ...
                    <span>{{ showAmount($withdraw->amount, 8, exceptZeros: true) }} {{ strtoupper($withdraw->userCoinBalance->miner->coin_code) }}</span>
                </li>
                <li class="list-group-item rounded-0 d-flex justify-content-between">
                ...
                <li class="list-group-item rounded-0 d-flex justify-content-between">
                    ...
                    <span>{{ showAmount($withdraw->userCoinBalance->balance, 8, exceptZeros: true) }} {{ strtoupper($withdraw->userCoinBalance->miner->coin_code) }}</span>
                </li>
                <li class="list-group-item rounded-0 d-flex justify-content-between">
