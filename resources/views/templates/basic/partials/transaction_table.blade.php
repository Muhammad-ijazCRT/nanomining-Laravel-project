            ...
            <tr>
                ...
                <td class="budget">
                    <small class="fw-bold @if ($trx->trx_type == '+') text-success @else text-danger @endif">
                        {{ $trx->trx_type }} {{ showAmount($trx->amount, 8, exceptZeros: true) }} {{ __(strtoupper($trx->currency)) }}
                    </small>
                </td>

                <td class="budget">
                    <small>
                        {{ showAmount($trx->post_balance, 8, exceptZeros: true) }} {{ __(strtoupper($trx->currency)) }}
                    </small>
                </td>
