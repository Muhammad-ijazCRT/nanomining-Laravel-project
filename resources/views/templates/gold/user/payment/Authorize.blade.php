                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input class="form--control" name="name" type="text" value="{{ old('name') }}" required autocomplete="off" autofocus />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input class="form--control" name="cardNumber" type="tel" value="{{ old('cardNumber') }}" autocomplete="off" required autofocus />
