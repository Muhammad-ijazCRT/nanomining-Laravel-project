                    ...
                    <form action="{{ route('ticket.reply', $myTicket->id) }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <textarea class="form--control" name="message" placeholder="@lang('Your Reply')" required rows="4">{{ old('message') }}</textarea>
                            </div>
                            ...
                            <button class="btn btn-outline--base w-100" type="submit"> <i class="fa fa-reply"></i> @lang('Reply')</button>
                        </div>
                    </form>
                </div>
            </div>
...
@push('script')
    <script>
        (function($) {
            ...
            $('#confirmationModal').find('.btn--primary').addClass('btn--sm');
