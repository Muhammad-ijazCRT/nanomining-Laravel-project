                ...
                <tbody>
                    ...
                    @forelse($deposits as $deposit)
                        <tr>
                            ...
                            <td class="text-center">
                                <div>
                                    <small class="d-block">{{ __($general->cur_sym) }}{{ showAmount($deposit->amount) }} + <span class="text-danger" data-bs-toggle="tooltip" title="@lang('charge')">{{ showAmount($deposit->charge) }} </span></small>
                            ...
                            <td class="text-center">
                                <div>
                                    <small class="d-block"> 1 {{ __($general->cur_text) }} = {{ showAmount($deposit->rate) }} {{ __($deposit->method_currency) }}</small>
                            ...
                            <td>
                                <button class="btn btn--base btn--sm @if ($deposit->method_code >= 1000) detailBtn @endif" type="button" @if ($deposit->method_code < 1000) disabled @endif @if ($deposit->method_code >= 1000) data-info="{{ $details }}" @endif @if ($deposit->status == Status::PAYMENT_REJECT) data-admin_feedback="{{ $deposit->admin_feedback }}" @endif>
