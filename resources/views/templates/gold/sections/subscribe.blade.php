...
<section class="subscribe section-bg bg-img" data-background-image="{{ asset($activeTemplateTrue . 'images/thumbs/subscribe-bg.png') }}">
    <div class="container">
        <div class="subscribe__inner">
            <img src="{{ getImage('assets/images/frontend/subscribe/' . @$subscribe->data_values->image, '260x250') }}" alt="@lang('image')" class="subscribe__thumb d-lg-block d-none">
            <div class="row align-items-end">
                ...
                <div class="col-xl-4 d-xl-block d-none">
                    <img src="{{ getImage('assets/images/frontend/subscribe/' . @$subscribe->data_values->arrow_image, '335x65') }}" alt="@lang('image')" class="subscribe__arrow">
                </div>
            </div>
        </div>
    </div>
