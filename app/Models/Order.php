...
class Order extends Model
{
    ...
    {
        return $this->belongsTo(UserCoinBalance::class, 'user_id', 'user_id');
    }

    public function ActiveMinedCoins()
    {
        return $this->hasMany(ActiveMinedCoin::class);
    }
}
