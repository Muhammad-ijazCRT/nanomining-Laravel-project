...
class SiteController extends Controller
{
    public function index()
    {
        ...
        return view($this->activeTemplate . 'user.custom_home', compact('pageTitle', 'sections'));
    }
    ...
    public function blogDetails($slug, $id)
    {
        ...
        $seoContents['image']              = getImage('assets/images/frontend/blog/' . @$blog->data_values->image, '810x450');
        $seoContents['image_size']         = '810x450';
