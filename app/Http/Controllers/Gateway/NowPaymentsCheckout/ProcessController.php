...
class ProcessController extends Controller
{
    public static function process($deposit)
    {
        ...
        $curl = curl_init();
        // dd($deposit);
        $orderId = 'RGDBP-' . $deposit->trx;

        $context = substr(strstr($orderId, 'RGDBP-'), strlen('RGDBP-'));
        // dd($context);
        ...
        //     'order_id' => $orderId,
        //     'order_description' => 'Buy Mining Plans',
        //     'ipn_callback_url' => route('user.home'),
        //     'success_url' => route('user.plans.purchased'),
        //     'cancel_url' => route('user.plans'),
        // ];
        ...
        // $response       = CurlRequest::curlPostContent('https://api-sandbox.nowpayments.io/v1/invoice', json_encode([
